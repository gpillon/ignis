...
| [hq vs BF16 decode cost](2026-09-13-hq-vs-bf16-decode-cost.md) | experiment | runtime / KV format, decode throughput, GPU utilization | 2026-09-13 | current | none | At matched pool geometry BF16 beats hq-e8-2b by 12.9% on C=1 and 13.5% on ITL p95 while the pool's page count moves the ITL cell by 0.05%, and the card is neither throttled (1,996 of 2,010 MHz, 49 °C) nor bandwidth-bound (memory idle ~75% of the time at 285-306 W of ~575 W) — hq buys footprint with SM cycles that do not become output. |

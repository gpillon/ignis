...
| [Sequence snapshot transfer cost](2026-09-12-sequence-snapshot-transfer-cost.md) | experiment | kernel / sequence state transfer, KV-RAM host tier | 2026-09-12 | current | none | Snapshot and restore both run at ~10 GB/s because this host caps the 5090 at PCIe Gen 3 x16, so a full-context round trip costs ~100 ms rather than ADR 0024's estimated ~42 ms — still 80–90x cheaper than the re-prefill it replaces. |

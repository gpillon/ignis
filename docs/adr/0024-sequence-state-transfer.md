...
- Costs are asymmetric and worth measuring rather than assuming: a
  ...
  - **Measured (P4-06, GitHub #124):** 508 MiB and **52 ms per direction**,
    not 21 ms. This host caps the 5090 at PCIe Gen 3 x16, so both directions
    run at ~10 GB/s. The asymmetry is 80–90x rather than ~220x, which leaves
    the decision unchanged; the estimate above was made at PCIe 5.0 rates.
    See

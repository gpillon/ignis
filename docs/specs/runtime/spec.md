...
(`docs/REVIEW-2026-09-05.md`). It replaces the `kernel-abi` feature area:
...
Roadmap and ticket map: `docs/ROADMAP.md` (G1 master #36, tickets #37–#62; masters #63–#66 for G2–G5).

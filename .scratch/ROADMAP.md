...
| P4-12 (#128) | G4 gate run and verdict | all | **Run 2026-09-12: gaps filed (#137, #138, #139), not a waiver.** Full verdict: `.scratch/REVIEW-2026-09-05.md` §6 Phase 4. GPU profile and dogfood clean; the primary per-class ratio and needle@128K cells are blocked by `ignis-bench` harness defects, not engine defects. #65 stays open pending #137/#138/#139 and a follow-up two-launch-per-engine session. |

...
The remaining op families (the fused GDN projections, GQA attention, the GDN
recurrence family) arrive with P1-12, P1-14 and P1-15, each adding its files
to this manifest and its reference op test to the leaf's test suite.
